# Install script for directory: /home/nur/LogicToolboxLib/src
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/nur/LogicToolboxLib/build/lib/liblogictoolbox.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/liblogictoolbox.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/liblogictoolbox.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/lib/liblogictoolbox.so"
...
file(INSTALL DESTINATION "/usr/local/include/logictoolbox" TYPE FILE FILES "/home/nur/LogicToolboxLib/build/src/version.h")
endif()
